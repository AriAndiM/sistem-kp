                      ...
                      <span style="color: red;">* </span><span>: Required (wajib diisi)</span><br><br>
                        <div class="row">
                          <div class="col-md-6 mb-4">
                            ...
                            <div class="form-outline">
                              <input type="text" id="NIM" class="form-control form-control-lg" placeholder="Masukkan nim anda..." require />
                          ...
                          <div class="col-md-6 mb-4">
                            ...
                            <div class="form-outline">
                              <input type="text" id="nama_mahasiswa" class="form-control form-control-lg" placeholder="Masukkan nama anda..." />
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-4">
                            ...
                            <div class="form-outline">
                              <input type="number" id="semester" class="form-control form-control-lg" placeholder="Masukkan semester anda..." />
                          ...
                          <div class="col-md-6 mb-4">
                            ...
                            <div class="form-outline">
                              <input type="number" id="sks_lulus" class="form-control form-control-lg" placeholder="Masukkan sks anda..." />
                        ...
                        <div class="row">
                          <div class="col-md-6 mb-4">
                            ...
                            <div class="form-outline">
                              <input type="number" id="IPK" class="form-control form-control-lg" placeholder="Masukkan ipk anda..." />
                          ...
                          <div class="col-md-6 mb-4">
                            ...
                            <div class="form-outline">
                              ...
                              <label class="form-label" for="form3Example1w">Upload Transkip Nilai <span style="color: red;">*</span></label>
                            </div>
