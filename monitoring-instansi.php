          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="row-lg-4">
                <div class="card card-small card-post mb-4">
                  <div class="card-body">
                    <h5 class="card-title">Monitoring 1</h5>
                    <p class="card-text text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corrupti natus vitae, quaerat sequi eum exercitationem officiis nemo maiores in voluptas nam laborum quae cupiditate magni provident autem pariatur mollitia dolore.</p>
                  </div>
                  <div class="card-footer border-top d-flex">
                    <div class="card-post__author d-flex">
                      <a href="#" class="card-post__author-avatar card-post__author-avatar--small" style="background-image: url('https://cdn.medcom.id/images/content/2021/07/13/1300074/0cPzq8tIjE.jpg');">Written by Anna Kunis</a>
                      <div class="d-flex flex-column justify-content-center ml-3">
                        <span class="card-post__author-name">PT. Telkom Bangkalan</span>
                ...
                <div class="card card-small card-post mb-4">
                  <div class="card-body">
                    <h5 class="card-title">Monitoring 2</h5>
                    <p class="card-text text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corrupti natus vitae, quaerat sequi eum exercitationem officiis nemo maiores in voluptas nam laborum quae cupiditate magni provident autem pariatur mollitia dolore.</p>
                  </div>
                  <div class="card-footer border-top d-flex">
                    <div class="card-post__author d-flex">
                ...
                <div class="card card-small card-post mb-4">
                  <div class="card-body">
                    <h5 class="card-title">Monitoring 3</h5>
                    <p class="card-text text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corrupti natus vitae, quaerat sequi eum exercitationem officiis nemo maiores in voluptas nam laborum quae cupiditate magni provident autem pariatur mollitia dolore.</p>
                  </div>
                  <div class="card-footer border-top d-flex">
                    <div class="card-post__author d-flex">
