              ...
              <div class="card card-small mb-4">
                <div class="card-body p-0 pb-3 text-center">
                  ...
                  <table class="table" style="text-align: left;">
                    <tr>
                      <td></td>
                      <td style="width: 300px; padding: 3px;"><b>Nilai Sidang Kerja Praktek = ... </b> <br> Bangkalan,...../..../.... <br> Dosen Pembimbing <br> <br> <br> <br> <br> <br> <b>Dosen Pembimbing</b> <br> NIP. </td>
                    </tr>
                  </table>
                  <div style="text-align: left;">
                    <a class="nav-link " href="cetak-penilaian-dosen.php">
