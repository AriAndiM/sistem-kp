            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12 mb-4">
                    <div class="card card-small card-post card-post--1">
                        ...
                        <a href="penilaian-instansi.php">
                        <div class="card-body">
                            <h5 class="card-title">Instansi / Perusahaan</h5>
                            <p class="card-text d-inline-block mb-3" style="color:black;">PT. Telkom Bangkalan</p>
                        </div>
                        </a>
                      </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-12 mb-4">
                    <div class="card card-small card-post card-post--1">
                        ...
                        <a href="penilaian-dosen.php">
                        <div class="card-body">
                            <h5 class="card-title">Dosen Pembimbing</h5>
                            <p class="card-text d-inline-block mb-3" style="color:black;">Muhammad, S.Kom., M.Kom.</p>
                        </div>
                        </a>
                      </div>
                </div>
